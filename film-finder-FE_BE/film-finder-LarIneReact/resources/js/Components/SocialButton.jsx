...
function SocialButton(props){
  return (
    <div className="mt-6 grid grid-cols-1 gap-1">
      <a href="#" className="w-full inline-flex justify-center py-3 px-4 border border-dark-border rounded-md shadow-sm bg-dark-border text-sm font-medium text-gray-500 hover:bg-white">
