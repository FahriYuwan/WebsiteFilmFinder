...
function Sidebar() {
  ...
  return (
    // <!-- Sidebar -->
    <aside id="sidebar" className="h-screen w-64 bg-dark-bg border-r border-dark-border shadow-sm flex flex-col sticky top-0">
      {/* <!-- Header --> */}
      <div className="p-4 pb-2 flex justify-between items-center">
        <img src="/images/just-text.png" id="sidebar-logo" className="w-60 overflow-hidden transition-all" alt="Logo" />
      ...
      <li className="relative flex flex-col py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors text-dark-text sidebar-item group">
        ...
        {/* <!-- Submenu --> */}
        <ul className="submenu pl-8 mt-1 transition-opacity duration-300 opacity-0 group-hover:opacity-100">
          <li className="py-2 px-3 text-gray-400 transition-colors rounded-md hover:bg-dark-card-bg">
            <a href="CMSDrama.html" className="w-full h-full block">Validate</a>
          </li>
          <li className="py-2 px-3 text-gray-400 transition-colors rounded-md hover:bg-dark-card-bg">
            <a href="CMSDramaInput.html" className="w-full h-full block">Input New Film</a>
          </li>
        </ul>
      ...
      {/* <!-- Countries Item --> */}
      <li className="relative flex flex-col py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors text-dark-text sidebar-item group active">
        <div className="flex items-center">
          <a href="CMSCountries.html" className="flex items-center rounded-md w-full">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
        ...
        {/* <!-- Awards Item --> */}
        <li className="relative flex flex-col py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors group-hover:text-dark-accent text-dark-text sidebar-item group">
          <div className="flex items-center">
            <a href="CMSAwards.html" className="flex items-center rounded-md w-full">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
        ...
        <li className="relative flex flex-col py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors text-dark-text sidebar-item group">
          <div className="flex items-center">
            <a href="CMSGenres.html" className="flex items-center rounded-md w-full">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
      ...
      <li className="relative flex flex-col py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors text-dark-text sidebar-item group">
        <div className="flex items-center">
          <a href="CMSActors.html" className="flex items-center rounded-md w-full">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
      ...
      <li className="relative flex flex-col py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors text-dark-text sidebar-item group">
        <div className="flex items-center">
          <a href="CMSComments.html" className="flex items-center rounded-md w-full">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 0 1 .865-.501 48.172 48.172 0 0 0 3.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z" />
          </svg>                           
          <span className="sidebar-item-text group-hover:text-dark-accent ml-2">Comments</span>
        </a>
        </div>
        <div className="tooltip absolute left-full rounded-md px-2 py-1 ml-6 bg-dark-hover text-dark-text text-sm -translate-x-3 text-center">
          Comments
      ...
      <li className="relative flex flex-col py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors text-dark-text sidebar-item group">
        <div className="flex items-center">
          <a href="CMSUsers.html" className="flex items-center rounded-md w-full">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
      ...
      <div className="border-t border-dark-border flex items-center p-3 mt-auto">
        <a href="Home.html" className="flex items-center text-dark-text hover:text-dark-accent transition duration-300">
